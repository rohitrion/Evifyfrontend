...
BsListCheck, BsMenuButtonWideFill, BsFillGearFill
    ...
    from 'react-icons/bs'
const Sidebar = ({ openSidebarToggle, OpenSidebar, onButtonClick }) => {
    return (
        <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive" : ""}>
            ...
            <ul className='sidebar-list'>
                ...
                <li className='sidebar-list-item'>
                    ...
                    <button onClick={onButtonClick}  style={{border:'none',background:"none" ,color:"#9E9EA4"}}  >File Upload</button>
