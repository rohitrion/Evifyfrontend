...
const Uptownfresh = () => {
    ...
    const handleUpload2 = async () => {
        try {
            ...
            const response = await axios.post(`${baseurl}/surat/uptown_fresh/structure/${final.file_id}/${final.file_name}`, formData, {
    ...
    useEffect(() => {
        const savedInputValues = localStorage.getItem('suratuptownfresh');
        if (savedInputValues) {
      ...
      useEffect(() => {
        localStorage.setItem('suratuptownfresh', JSON.stringify(rentmodal));
      }, [rentmodal]);
    return (
        ...
        <>
            ...
            <div className="flex items-center justify-center">
                ...
                <main className="bg-white p-4 rounded shadow-lg w-120 lg:w-144 overflow-y-auto max-h-[900px] ">
                    <h3 className="text-3xl text-center pb-2 font-bold">Uptown-Fresh</h3>
